  ...
  docInfo && (
    <section className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        {/* Days */}
<div className="mt-6 flex gap-3 overflow-x-auto pb-2">          {docSlot.map((slots, index) => {
  ...
  slotIndex === index
    ...
    : "border-slate-200 bg-white text-slate-700 hover:border-blue-600"
              ...
              >
<p className="text-xs font-medium">                  {daysOfWeek[firstSlot.datetime.getDay()]}
                </p>

<p className="mt-1 text-lg font-bold">                  {firstSlot.datetime.getDate()}
                </p>
              </button>
            );
          })}
        ...
        {/* Time Slots */}
<div className="mt-6 flex flex-wrap gap-2">          {docSlot.length > 0 &&
